...
gc = pygsheets.authorize(service_account_file=r"C:\Users\jack\business_program\project\pbc-recipe.json")
...
def create_page_1():
    im = Image.open(r"C:\Users\jack\business_program\project\淺色1號.jpg")  # 淺色1號
...
def create_page_2():
    im = Image.open(r"C:\Users\jack\business_program\project\淺色2號.jpg")  # 淺色2號
    im = im.resize((1050, 700))
    img = ImageTk.PhotoImage(im)
...
def create_page_3():
    im = Image.open(r"C:\Users\jack\business_program\project\淺色3號.jpg")  #淺色3號
    im = im.resize((1050, 700))
    img = ImageTk.PhotoImage(im)
